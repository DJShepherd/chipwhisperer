...
class BitField(object):
    ...
    def extr_value(self, istruct):
        ...
        """
        return self.extr_field(field) >> self.pos
...
class VarToEnumTranslation(VarToAPITranslation):
    ...
    def try_var_to_api(self, value, default=-1):
        ...
        if isinstance(value, int):
            return value
        return super().try_var_to_api(value, default)
...
class ObjToStrTranslation(object):
    ...
    def try_api_to_str(self, value):
        return self._str_dict.get(value, default=None)
...
class EnumTranslationDirect(VarToEnumTranslation, EnumToStrTranslation):
    ...
    def try_var_to_api(self, value, default=-1):
        ...
        if not isinstance(value, int):
            return VarToEnumTranslation.try_var_to_api(self, value, default)
...
class EnumTranslationToHW(EnumTranslationDirect):
    ...
    def __init__(self, hw_list, str_list, var_map):
        super().__init__(str_list, var_map)
...
class EnumTranslationAPI(EnumTranslationToHW):
    ...
    def try_hw_to_str(self, value, edefault=-1):
        value = self.try_hw_to_api(value, edefault)
        if value == edefault:
            return None
